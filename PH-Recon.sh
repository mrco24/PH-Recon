...
do
mkdir -p /root/PH-PH-Recon/$domain/subdomain /root/PH-PH-Recon/$domain/subdomain/good  /root/PH-PH-Recon/$domain/Subomain-Takeover /root/PH-PH-Recon/$domain/Subomain-Screenshots /root/PH-PH-Recon/$domain/Special_subdomain /root/PH-PH-Recon/$domain/Special_subdomain/scan /root/PH-PH-Recon/$domain/scan  /root/PH-PH-Recon/$domain/scan/my-jaeles /root/PH-PH-Recon/$domain/scan/jaeles /root/PH-PH-Recon/$domain/scan/jaeles/my-url /root/PH-PH-Recon/$domain/scan/jaeles/url /root/PH-PH-Recon/$domain/dri  /root/PH-PH-Recon/$domain/scan/nuclei/Php-My-Admin /root/PH-PH-Recon/$domain/scan/nuclei /root/PH-PH-Recon/$domain/scan/new-nuclei /root/PH-PH-Recon/$domain/url /root/PH-PH-Recon/$domain/Secret-api /root/PH-PH-Recon/$domain/gf /root/PH-PH-Recon/$domain/xss /root/PH-PH-Recon/$domain/sql /root/PH-PH-Recon/$domain/js_url /root/PH-PH-Recon/$domain/git_dork /root/PH-PH-Recon/$domain/SQL
