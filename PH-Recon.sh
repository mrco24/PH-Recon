...
for domain in $(cat $host);
do
httpx -l /root/PH-Recon/$domain/subdomain/all_srot_sub.txt -threads 150 -o /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt 
done
}
resolving_domains
...
for domain in $(cat $host);
do
subzy run --targets /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt | tee -a /root/PH-Recon/$domain/Subomain-Takeover/sub_poc.txt
done
}
Subdomai_takeover
...
for domain in $(cat $host);
do
naabu -list /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt -top-ports 1000 -exclude-ports 80,443,21,22,25 -o /root/PH-Recon/$domain/scan/open-port.txt
naabu -list /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt -p - -exclude-ports 80,443,21,22,25 -o /root/PH-Recon/$domain/scan/filter-all-open-port.txt
done
}
open_port
...
#for domain in $(cat $host);
#do
#cd /root/OK-VPS/tools/http-request-smuggling | python3 smuggle.py -urls /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt | tee -a /root/PH-Recon/$domain/scan/Http-Request-Smugglingr.txt
#done
#}
#Http-Request-Smugglingr
...
for domain in $(cat $host);
do
cf-check -d /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt | tee -a /root/PH-Recon/$domain/subdomain/good/cloudflare_check.txt
done
}
CloudFlare_Checker
...
for domain in $(cat $host);
do
nuclei -l /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt -t /root/nuclei-templates/ -c 50 -o /root/PH-Recon/$domain/scan/new-nuclei/All.txt -v
jaeles scan -c 50 -s /root/templates/jaeles-signatures -U /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt -o /root/PH-Recon/$domain/scan/jaeles/ -v
done
}
vuln_scanner
...
for domain in $(cat $host);
do
cat /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt |  gauplus -t 40 | tee -a /root/PH-Recon/$domain/url/gaplus-urls.txt
cat /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt | waybackurls | tee /root/PH-Recon/$domain/url/waybackurls.txt
cat /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt | hakrawler | tee -a /root/PH-Recon/$domain/url/hakrawler-urls.txt
gospider -S /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt -c 10 -d 1 --other-source | grep -o 'https\?://[^ ]\+' > /root/PH-Recon/$domain/url/gospider-url.txt
...
for domain in $(cat $host);
do
cat /root/PH-Recon/$domain/url/final-url.txt | cut -d "/" -f4- >> /root/PH-Recon/$domain/url/url_endpoints.txt
done
}
Url_endpoints
...
for domain in $(cat $host);
do
gf xss /root/PH-Recon/$domain/url/valid_urls.txt | tee /root/PH-Recon/$domain/gf/xss.txt
gf my-lfi /root/PH-Recon/$domain/url/valid_urls.txt | tee /root/PH-Recon/$domain/gf/my-lfi.txt
gf sqli /root/PH-Recon/$domain/url/valid_urls.txt | tee /root/PH-Recon/$domain/gf/sqli.txt
gf lfi /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/lfi.txt
gf redirect /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/rmy-lfiedirect.txt
gf aws-keys /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/aws-keys-json.txt
gf interestingsubs /root/PH-Recon/$domain/subdomain/good/active_subdomain.txt |  tee /root/PH-Recon/$domain/gf/interestingsubs.txt
gf s3-buckets /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/s3-buckets.txt
gf servers /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/servers.txt
gf debug-pages /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/debug-pages.txt
gf debug_logic /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/debug_logic.txt
gf img-traversal /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/img-traversal.txt
gf php-sources /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/php-sources.txt
gf upload-fields /root/PH-Recon/$domain/url/valid_urls.txt |  tee /root/PH-Recon/$domain/gf/upload-fields.txt
